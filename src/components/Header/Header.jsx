...
export const Header = () => {
  ...
  const handleMinusButtonClick = () => {
    if (itemQuantity > 1) {
      ...
      recalculateTotalPrice(itemQuantity - 1);
    }
  };
  ...
  const recalculateTotalPrice = (newQuantity) => {
    const index = basketItems.findIndex((item) => item === addedItem);
                    ...
                    <div key={index}>
                      <BasketDish>
                        ...
                        <DownContentDish>
                          ...
                          <AmountBasketDish>
                            <MinusButton onClick={handleMinusButtonClick}>
                              -
                            </MinusButton>
                            <p>{itemQuantity}</p>
